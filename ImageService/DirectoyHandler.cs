...
namespace Logic
{
    public class DirectoyHandler : IDirectoryHandler
    {
        ...
        {
            DebugLogger.Instance.Log(this, new LogMessageArgs(LogMessageTypeEnum.INFO, "start directory"));
        ...
        {
            DebugLogger.Instance.Log(this, new LogMessageArgs(LogMessageTypeEnum.INFO, "in file created"));
